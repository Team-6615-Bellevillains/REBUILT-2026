...
public class ShootOnTheMoveDebugCommand extends Command {
  ...
  private Field2d lookaheadPoseField = new Field2d();
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber("SOTM/commanded shooter speed",launchFlywheelSpeedMap.get(lookaheadTurretToTargetDistance));
    lookaheadPoseField.getObject("lookahead pose").setPose(lookaheadPose);
    SmartDashboard.putData("SOTM/lookahead pose", lookaheadPoseField);

    SmartDashboard.putNumber("SOTM/Distance to Target", lookaheadTurretToTargetDistance);
