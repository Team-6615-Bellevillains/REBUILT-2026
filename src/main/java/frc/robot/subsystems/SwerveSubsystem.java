...
public class SwerveSubsystem extends SubsystemBase{
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Vision/rotationFedToLimelight", currentPose.getRotation().getDegrees());
        ...
        SmartDashboard.putData("Vision/Limelight4Field", limelight4Field);
        SmartDashboard.putData("Vision/Limelight3gField", limelight3gField);
        ...
        SmartDashboard.putNumber("Targeting/feetToHub", Units.metersToFeet(hubDistance));
        SmartDashboard.putNumber("Targeting/measuredSpeedMetersPerSecond", Math.hypot(drive.getFieldVelocity().vxMetersPerSecond, drive.getFieldVelocity().vyMetersPerSecond));
    }
